...
public class TupleDesc implements Serializable {
    ...
    public TupleDesc(Type[] typeAr, String[] fieldAr) {
        ...
        for (int i=0; i<typeAr.length; i++) {
            this.SchemaList.add(new TDItem(typeAr[i], fieldAr[i]));
        }
    }
    ...
    public TupleDesc(Type[] typeAr) {
        ...
        this.SchemaList = new Vector();
        for (int i=0; i<typeAr.length; i++) {
            this.SchemaList.add(new TDItem(typeAr[i], null));
        }
    }
    ...
    public String getFieldName(int i) throws NoSuchElementException {
        ...
        String fn;
        try {
            fn = this.SchemaList.get(i).fieldName;
    ...
    public Type getFieldType(int i) throws NoSuchElementException {
        ...
        Type ft;
        try {
            ft = this.SchemaList.get(i).fieldType;
        } catch (ArrayIndexOutOfBoundsException e) {
            throw new NoSuchElementException();
        }
    ...
    public int getSize() {
        // some code goes here
        int total = 0;
        for (Iterator<TDItem> i = this.SchemaList.iterator(); i.hasNext();) {
